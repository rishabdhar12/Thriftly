...
class ResetCategoriesUsecase extends BaseUsecase<List<Categories>, NoParams> {
  final CategoriesRespository _categoriesRespository;

  ResetCategoriesUsecase(this._categoriesRespository);

  @override
  Future<Either<Failure, List<Categories>>> call(NoParams params) async {
    return await _categoriesRespository.resetCategories();
  }
}
